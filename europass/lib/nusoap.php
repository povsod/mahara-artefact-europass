...
//		}
		...
		if ($this->scheme == 'https') {
			...
			// Absolute path to ca-bundle.crt file, which is in the same directory/folder as nusoap.php
			$this->setCurlOption(CURLOPT_CAINFO, dirname(__FILE__)."/ca-bundle.crt");		
